...
/**
 * Computes the range on an axis occupied by the projection of a polygon onto
 * the axis. If normalize is false, the axis is assumed to have norm 1. Returns
 * a range of min 0 and max 0 if the axis is the zero vector.
 *
 * @param polygon the list of vertices that make up the polygon
 * @param axis the axis onto which to project the polygon
 * @param normalize whether to normalize the axis
 * @return the range of the scalar projection of the polygon onto the axis
 */
